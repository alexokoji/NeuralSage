...
SYSTEM_STRATEGIES = [
    ...
    {
        "name": "Forex EMA Trend",
        "type": "forex_ema_trend",
        "description": "EMA 20/50 trend-following for forex pairs. Wider stops for forex volatility.",
        "default_params": {
            "fast_ema": 20,
            "slow_ema": 50,
            "stop_loss_pct": 0.5,
    ...
    {
        "name": "Forex RSI Reversal",
        "type": "forex_rsi_reversal",
        "description": "RSI mean-reversion for forex. Tighter entries on major pairs.",
        "default_params": {
            "rsi_period": 14,
            "oversold": 25,
            "overbought": 75,
